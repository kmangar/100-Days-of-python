...
quote_text = canvas.create_text(150, 207, text="Click trump Get A Quote", width=250, font=("Arial", 28, "bold"), fill="white")
canvas.grid(row=0, column=0)

# image credit: https://pngimg.com/image/29355
trump_img = PhotoImage(file="img/donald_trump.png")
